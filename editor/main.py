...
def main():
    ...
    if len(sys.argv) < 3:
        print("Usage: python -m editor.main <terrain_chr.bin> <greens_chr.bin> [hole.json]")
        print("")
        print("Example:")
        print("  python -m editor.main data/chr-ram.bin data/green-ram.bin")
        print("  python -m editor.main data/chr-ram.bin data/green-ram.bin courses/japan/hole_01.json")
        sys.exit(1)
