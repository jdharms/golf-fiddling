...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the randomizer website under uvicorn.")
    ...
    uvicorn.run("server.app:create_app", factory=True, host=args.host, port=args.port, reload=args.reload)
    return 0
